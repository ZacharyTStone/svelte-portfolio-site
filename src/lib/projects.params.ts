...
const MY_PROJECTS: Array<Project> = [
	...
	},
	{
		...
		project_skills: [
			{ label: 'React', to: 'https://react.dev/' },
			{ label: 'CSS', to: 'https://css.dev/' },
			{ label: 'Node', to: 'https://node.dev/' },
			{ label: 'API', to: 'https://api.dev/' },
			{ label: 'Authentication', to: 'https://authentication.dev/' },
			{ label: 'MongoDB', to: 'https://mongodb.dev/' },
			{ label: 'Heroku', to: 'https://heroku.dev/' },
		],
		type: 'Web Application',
		english: true,
		japanese: false
